...
import type { UpdatePublicationUrlResponseDtoStatus } from './updatePublicationUrlResponseDtoStatus';

export interface UpdatePublicationUrlResponseDto {
  /** Unique identifier */
  id: string;
  ...
  status: UpdatePublicationUrlResponseDtoStatus;
  /**
